...
const MyCamp = () => {
  ...
  useEffect(() => {
    ...
    //     }
    //   });
    axiosInstance.get(`/myCampaign/${email}`).then((res) => {
        ...
        fetch(`https://give-ngrow-server.vercel.app/deleteMyCampaign/${id}`, {
          ...
          .then((data) => {
            if (data.deletedCount > 0) {
              ...
              const remainingCampaign = myCampaign.filter(
                (camp) => camp._id !== id
              );
    ...
    <div className="my-12 p-4">
      ...
      <div>
        <Info
          ...
          subtitle={
            "Discover the stories and causes created by our community. Together, we can make a difference."
          }
        />
      </div>
